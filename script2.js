...
// }
  ...
  if(scalpCon.includes('Sensitive (Dryness/ Weakness / Rashes)')|| scalpCon.includes('Oily')||  scalpCon.includes('Dandruff')){
    hairServ.textContent='Scalp Renwal Restorative Treatment';
    document.getElementById('service').value= hairServ.textContent;
    // document.querySelector('.servImg').src='./assets/images/compressed/sp-serv.png'
    servPrice.innerHTML = 'Rs.4700/-<sup>*</sup> onwards <br><sub> *All service prices are exclusive of Tax</sub>';
    if(gender === 'Female'){
  ...
  else if(scalpCon.includes('Hair Fall')){
    hairServ.textContent='Invati Restorative Treatment';
    document.getElementById('service').value= hairServ.textContent;
    // document.querySelector('.servImg').src='./assets/images/compressed/sp-serv.png'
    servPrice.innerHTML = 'Rs.4700/-<sup>*</sup> onwards <br><sub> *All service prices are exclusive of Tax</sub>';
    if(gender === 'Female'){
  ...
  if(hairCon.includes('Fine/ Lack of volume')){
    ...
    hairServ.textContent = 'Be Curly / Nutriplenish Restorative Treatment';
    document.getElementById('service').value= hairServ.textContent;
    // document.querySelector('.servImg').src='./assets/images/compressed/sp-serv.png'
    servPrice.innerHTML = 'Rs.3200/-<sup>*</sup> onwards <br><sub> *All service prices are exclusive of Tax</sub>';
    if(gender === 'Female'){
        if(hairCon.includes('Fine/ Lack of volume')){
            // prodsRec.textContent = 'Volupt';
    ...
    hairServ.textContent = 'Botanical Restorative Treatment';
    document.getElementById('service').value= hairServ.textContent;
    servPrice.innerHTML = 'Rs.4700/-<sup>*</sup> onwards<br> <sub> *All service prices are exclusive of Tax</sub>';
    ...
    hairServ.textContent = 'Nutriplenish Restorative Treatment';
    document.getElementById('service').value= hairServ.textContent;
    servPrice.innerHTML = 'Rs.3000/-<sup>*</sup> onwards <br><sub> *All service prices are exclusive of Tax</sub>';
    // document.querySelector('.servImg').src='./assets/images/avenda/.png'
    if(gender == 'Female'){
